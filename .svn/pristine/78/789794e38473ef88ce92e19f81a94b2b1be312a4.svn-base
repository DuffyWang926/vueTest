<template>
  <el-dialog title="车辆详情" class="lg-dialog seeCarInfoDialog" :visible.sync="visible" :msg="msg" :append-to-body='appendToBody' :close-on-click-modal="false" :before-close="cancelModal">
    <div style="width:33%; padding-bottom: 30px">
    ...
    <div class="dialog-right" style="width:59%; position: absolute; right:0; top:90px; padding-right: 36px;">
      ...
      <div v-show="isSecondShow">
        ...
        <el-table
          ...
          <el-table-column
            ...
            width="160"
            label="离场时间">
            <template slot-scope="scope" v-if="scope.row.lwsj">
      ...
      <div v-show="isThirdShow">
        ...
        <el-table
          ...
          <el-table-column
            ...
            width="180"
            label="解绑时间">
            <template slot-scope="scope" v-if="scope.row.jbrq">
    ...
    methods:{
      ...
      getCarInfo(hphm,cpys) {
        fetchCarInfoInfo(hphm,cpys).then(response => {
          ...
          this.getCarBindHistoryInfo(this.id);
          this.rzsj = response.result.rzsj;
          this.yhxm = response.result.yhxm;
          this.yhsjh = response.result.yhsjh;
